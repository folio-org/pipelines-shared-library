...
void deployMockServer(RancherNamespace ns) {
  ...
  String configFileUrl = Constants.FOLIO_GITHUB_RAW_URL + "/folio-integration-tests/master/mod-inn-reach/" + "src/main/resources/vega/mod-inn-reach/mocks/general/mockserverInitialization.json"
