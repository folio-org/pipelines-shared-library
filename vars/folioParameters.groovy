...
def s3Type(List value = Constants.AWS_INTEGRATED_SERVICE_TYPE.reverse()) {
  return _paramChoice('S3_BUCKET', value, 'Select object storage type: AWS S3 or built-in MinIO')
}
