...
ListImagesRequest request = new ListImagesRequest().withRepositoryName("ui-test");
...
return result[0].imageTag.sort().reverse().findAll{it.startsWith(rancher_cluster_name.trim() + '-' + rancher_project_name.trim())} - null;
"""
}
