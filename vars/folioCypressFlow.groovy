...
void tuneWorkspaceForRP(){
  String cypressReporter = "reportportal/@reportportal/agent-js-cypress/lib/cypressReporter.js"
  String report_portal_client = "reportportal/@reportportal/client-javascript/lib/report-portal-client.js"
  String config = "reportportal/@reportportal/client-javascript/lib/commons/config.js"

  writeFile file: "./node_modules/${report_portal_client}", text: libraryResource("${report_portal_client}")
  writeFile file: "./node_modules/${cypressReporter}", text: libraryResource("${cypressReporter}")
  writeFile file: "./node_modules/${config}", text: libraryResource("${config}")
}
