  ...
  try {
    folioHelm.withK8sClient {
      ...
      if (pod) {
        ...
        sh(script: "kubectl exec --request-timeout=20s --namespace=${namespace} ${pod} -- /usr/local/pgsql-16/psql -c 'DROP SCHEMA IF EXISTS ${moduleId}__system CASCADE'", returnStatus: false)
