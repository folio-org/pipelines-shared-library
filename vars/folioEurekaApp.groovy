...
void generateApplicationDescriptorFile(String applicationId) {
  ...
  dir(applicationId) {
    ...
    awscli.withAwsClient() {
      sh(script: "mvn clean install -U -DbuildNumber=${BUILD_NUMBER} -DbeRegistries=\"s3::${mdrBucket}::/,s3::${mdrBucket}::descriptors/\" -DuiRegistries=\"okapi::${publicMdr}\" -DawsRegion=us-west-2 -DoverrideConfigRegistries=true")
