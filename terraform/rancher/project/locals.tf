...
locals {
  ...
  system_user_modules   = ["mod-data-export-spring", "mod-inn-reach", "mod-search", "mod-consortia", "mod-remote-storage", "mod-entities-links", "mod-erm-usage-harvester", "mod-pubsub", "mod-dcb", "mod-lists", "	mod-consortia-keycloak", "mod-scheduler"]
