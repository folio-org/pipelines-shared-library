...
resource "helm_release" "keycloak" {
  count        = (var.eureka ? 1 : 0)
  chart        = "keycloak"
  depends_on   = [rancher2_secret.keycloak-credentials, rancher2_secret.db-credentials, helm_release.postgresql, module.rds.cluster_instances, null_resource.create_extra_dbs4eureka]
