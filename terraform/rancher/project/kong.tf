...
resource "helm_release" "kong" {
  count      = var.eureka ? 1 : 0
  chart      = "kong"
  depends_on = [rancher2_secret.db-credentials, helm_release.postgresql, rancher2_secret.kong-credentials, module.rds.cluster_instances, postgresql_database.eureka_kong]
