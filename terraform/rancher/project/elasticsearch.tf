...
resource "rancher2_app" "elasticsearch" {
  ...
  template_version = "18.2.6"
  answers = {
    #    "global.elasticsaerch.service.name"      = rancher2_project.project.name
    "image.debug"                                    = "true"
    "image.tag"                                      = "7.17.4"
    ...
    "master.livenessProbe.initialDelaySeconds"       = "240"
    ...
    "coordinating.livenessProbe.initialDelaySeconds" = "240"
    "data.replicaCount"                              = "1"
    ...
    "data.livenessProbe.initialDelaySeconds"         = "240"
    "ingest.livenessProbe.initialDelaySeconds"       = "240"
