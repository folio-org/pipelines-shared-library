                    ...
                    if (install_edge_map) {
                        helm.k8sClient {
                            ...
                            install_edge_map.each {name, version ->
                                writeFile file: "${name}-ephemeral-properties", text: new Edge(this, "https://${project_config.getDomains().okapi}").renderEphemeralProperties(install_edge_map, tenant, admin_user)
