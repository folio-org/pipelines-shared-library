...
class SlackTestResultTemplates {
  ...
  static final CYPRESS_TEXT = 'Build name: ${TEST_TXT_BUILD_NAME}. Passed tests: ${TEST_TXT_PASS_CNT}, Broken tests: ${TEST_TXT_BRK_CNT}, Failed tests: ${TEST_TXT_FAIL_CNT}, Skipped tests: ${TEST_TXT_SKIP_CNT}, Pass rate: ${TEST_TXT_PASS_RATE}%'
