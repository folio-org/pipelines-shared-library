...
class SlackTeamTestResultTemplates {
  ...
  static final FAILED_TEXT = '*${TEAM_TEST_TXT_FAILED_CNT}* of *${TEAM_TEST_TXT_TOTAL_CNT}* modules has been failed for *${TEAM_TEST_TXT_TEAM_NAME}* team'
  ...
  static final FAILED_MODULE_FIELD_VALUE = 'Has *${TEAM_TEST_FIELD_FAILED_CNT}* failures of *${TEAM_TEST_FIELD_TOTAL_CNT}* total tests'
  ...
  static Map<String, String> getFieldParams(String moduleName, String failedCount, String totalCount){
    [
      'TEAM_TEST_FIELD_MODULE_NAME' : moduleName
      , 'TEAM_TEST_FIELD_FAILED_CNT' : failedCount
      , 'TEAM_TEST_FIELD_TOTAL_CNT' : totalCount
    ]
  }
}
