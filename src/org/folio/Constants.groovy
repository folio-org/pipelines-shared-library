...
class Constants {
  ...
  static String BUGFEST_SNAPSHOT_NAME = 'folio-general-dataset-april-2025-all-users-clean'
  static String DATA_MIGRATION_SNAPSHOT_NAME = 'folio-general-dataset-april-2025-all-users-clean'
