...
class Constants {
  ...
  static List AWS_EKS_TMP_NAMESPACES = ['cikarate', 'cicypress', 'test', 'test-1', 'test-2', 'tdspora']
  ...
  static final String JENKINS_CREATE_NAMESPACE_FROM_BRANCH_JOB =
    "$JENKINS_FOLIO_RANCHER_FOLDER/tmpFolderForDraftPipelines/YaroslavI/createNamespaceFromBranch-RANCHER-1692-two"
