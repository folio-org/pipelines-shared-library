...
class Constants {
  ...
  static List AWS_EKS_TESTING_NAMESPACES = ['athena','cypress', 'data-migration', 'data-anonymization', 'release-validation', 'ecs-snapshot', 'karate', 'snapshot', 'snapshot2', 'sprint', 'sprint2', 'pre-bugfest', 'orchid-migration', 'lsdi']
  ...
  static String PSQL_DUMP_HELM_INSTALL_CHART_VERSION = '1.0.10'
  ...
  static String CYPRESS_ALLURE_VERSION = '2.35.1'
